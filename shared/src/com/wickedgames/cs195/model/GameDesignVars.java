...
public final class GameDesignVars {
	...
	public static final Integer	MAX_SERVER_UPDATE_RATE = 5; 			// updates per second
	public static final Float   TIME_BETWEEN_UPDATES = 1.0f/MAX_SERVER_UPDATE_RATE; 	// seconds per update
