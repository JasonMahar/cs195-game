...
public class Hero extends BaseActor {
    ...
    public Hero(float x, float y, Stage s) {
        ...
        super(x, y, s);
        //String[] fileName = {"ninja_cat/run/ninja-run_00.png", "ninja_cat/run/ninja-run_01.png", "ninja_cat/run/ninja-run_02.png", "ninja_cat/run/ninja-run_03.png", "ninja_cat/run/ninja-run_04.png", "ninja_cat/run/ninja-run_05.png"};
        String fileName = "chiken.png";
        int rows = 4;
        int cols = 4;
